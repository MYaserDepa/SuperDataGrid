...
export function dataGridPlusTemplate(ctx) {
	...
	return `
  <div ref="dataGridPlus" class="dataGridPlus-${compKey}" style="border: 3px solid #ddd; padding: 10px; overflow-x: auto;">
  ...
  <div ref="dataGridPlus" class="dataGridPlus-${compKey}" style="border-left: 3px solid #ddd; border-right: 3px solid #ddd; border-bottom: 3px solid #ddd; border-top: none; padding: 10px; text-align: right;">
    <div class="pager">
        <div class="nav-controls">
          <span class="items-on-page">
            <span ref="firstItemNum">1</span>
