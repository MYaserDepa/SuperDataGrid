...
export function dataGridPlusTemplate(ctx) {
  ...
  return `
  <div ref="container" style="background-color: #f5f5f5; padding: 5px; border-top: 3px solid #ddd; border-left: 3px solid #ddd; border-right: 3px solid #ddd">
  <div ref="targetComponentTitle"></div>
    <div ref="dataGridPlus" class="dataGridPlus-${compKey}" style="padding: 10px; overflow-x: auto;">
      <div class="dataGridPlus-controls" style="display: flex; flex-wrap: nowrap; gap: 20px; align-items: flex-start; min-width: 520px;">
    ...
    <div ref="dataGridPlus" class="dataGridPlus-${compKey}" style="padding: 10px; text-align: right;">
      <div class="pager">
